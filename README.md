...
- **장기 규칙 엔진** — 차/마/상/포/사/왕/병/졸 전체 이동 규칙 완전 구현
...
- 차(Cha): 가로/세로 무제한 이동
- 마(Ma): 한 칸 직진 → 한 칸 대각
- 상(Sang): 두 칸 직진 → 한 칸 대각
- 포(Po): 포는 ‘말을 뛰어넘어’ 공격 가능
- 병/졸(Byeong/Jol): 앞으로 한 칸씩
- 사(Sa): 왕 주변 3×3 안에서 대각 이동
- 왕(King): 3×3 궁성 안에서 상하좌우/대각 이동
